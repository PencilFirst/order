...
/***/ 11:
/*!***************************************!*\
  !*** C:/project/orderApp/util/api.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.myRequest = void 0;var BASE_URL = 'http://ustbhuangyi.com/sell/api';
...
/***/ 12:
/*!*****************************************************!*\
  !*** C:/project/orderApp/static/fonts/iconfont.css ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 13:
/*!******************************************!*\
  !*** C:/project/orderApp/store/index.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    changeOrderStatus: function changeOrderStatus(state, orderNumber) {
      // const _this = this
      state.orderList.forEach(function (item) {
        item.orderNumber === orderNumber ? _vue.default.set(item, 'status', 1) : '';
        // item.status = 1

      });
    },
    getGoods: function getGoods(state, goods) {
      state.goods = goods;
    },
    add: function add(state, payload) {
      ...
      if (!state.goods[first].foods[second].count) {
        _vue.default.set(state.goods[first].foods[second], 'count', 1);
      } else {
        state.goods[first].foods[second].count++;
      }
    },
    desc: function desc(state, payload) {var
  ...
  getters: {
    ...
    getUnfinshOrder: function getUnfinshOrder(state) {
      var unfinishList = [];
      state.orderList.forEach(function (item) {
        item.status == 0;
    ...
    selectFoods: function selectFoods(state) {
      var foods = [];
      state.goods.forEach(function (good, goodIndex) {
        good.foods.forEach(function (food, foodIndex) {
          if (food.count) {
            _vue.default.set(food, 'payload', {
              first: goodIndex,
              second: foodIndex });
...
/***/ 150:
/*!*********************************************************!*\
  !*** C:/project/orderApp/components/uni-icons/icons.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 24:
/*!******************************************!*\
  !*** C:/project/orderApp/util/data.json ***!
  \******************************************/
/*! exports provided: seller, goods, ratings, default */
/***/ (function(module) {
...
/***/ 57:
/*!****************************************!*\
  !*** C:/project/orderApp/util/date.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 79:
/*!*********************************************!*\
  !*** C:/project/orderApp/util/miniStore.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.saveToLocal = saveToLocal;exports.loadFromLocal = loadFromLocal;function saveToLocal() {var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;var key = arguments.length > 1 ? arguments[1] : undefined;var value = arguments.length > 2 ? arguments[2] : undefined;
  // let seller = window.localStorage.__seller__;
  // let seller = uni.setStorageSync()
  var seller = uni.getStorageInfoSync('__seller__');
  if (!seller) {
    seller = {};
    seller[id] = {};
  } else {
...
function loadFromLocal() {var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;var key = arguments.length > 1 ? arguments[1] : undefined;var def = arguments.length > 2 ? arguments[2] : undefined;
  // let seller = window.localStorage.__seller__;
  var seller = uni.getStorageInfoSync('__seller__');
  if (!seller) {
    return def;
